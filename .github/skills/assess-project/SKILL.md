---
name: assess-project
description: Assess the project for modernization. Use the skill if user provided github issue in input
---
...
3. **Install And Run Assessment Tools**:
   - Use the mcp tool 'appmod-precheck-assessment' to check and install the AppCat CLI.
